...
#حقوق مرسليو @ - @XIX_A
# تطوير مرسليو اذا ما ذكرت مصدر بنحكح امك @XIX_A - @PP_KU 
ownerID = int("7131944336") #ايدي الادمن 
...
bot = Client(
  'bot'+token.split(":")[0],
  29827985, #ايبي ايدي
 '50628f5396f918ea99c3535896fb1c47', #ايبي هاش
...
- إذا كنـت تريـد تنصيب لي بوت ميوزك فاختر بايروجـرام أمـا إذا كـان رقمك حقيقـي فاختر تيليثون .
 - ملاحظـة :
